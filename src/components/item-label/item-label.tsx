import styles from "./item-label.module.css";
...
function SelectLabel({ languageName, onClick }: ItemLabelProps): JSX.Element {
    return (
        <div className={styles.selectContainer}>
            <div className={styles.selectLabel} data-value="value1">{languageName}</div>
            <svg
                width="8"
                height="8"
                viewBox="0 0 8 8"
